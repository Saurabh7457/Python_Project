...
class BusBookingSystem(Tk):
    ...
    def front_page():
        ...
        Label(root,text="Online Bus Booking System",font='calibri 28 bold',fg='Red',bg="SkyBlue1").grid(row=1,column=0,pady=h//25)
        Label(root,text="Name : Saurabh Kumar Singh",font='calibri 16 bold',fg='Blue').grid(row=2,column=0,pady=h//50)
        Label(root,text="Er : 211B423 ",fg="BLue",font='calibri 16 bold').grid(row=3,column=0,pady=h//50)
        Label(root,text="Mobile : 7457990264",fg="BLue",font='calibri 16 bold').grid(row=4,column=0,pady=h//50)
        Label(root,text="Submitted to : Dr. Mahesh Kumar",fg="Red",bg="SkyBlue1",font='calibri 20 bold').grid(row=5,column=0,pady=h//25)
        Label(root,text="Project Based Learning",font='calibri 14 bold',fg="Red").grid(row=6,column=0)
        def close(x=0):
            root.destroy()
            obj.Home_page()
...
##        def check_seat_mob(num):
##            num1=int(num)
##            if (num1/1000000000)==0:
##                return False
##            else:
##                return num.isnumeric()
        ...
        def checking(name,seats,mobileNumber,age,JDate,going,idd):
            ...
            if len(name)==0:
                ...
                if checkTo(name)==True:
                    if check_seat_mob_age(seats)==True:
                        if check_seat_mob_age(mobileNumber)==True:
                            if check_seat_age(age)==True:
                                sure(name,seats,mobileNumber,age,JDate,going,idd)
                            else:
                                messagebox.showwarning('Invalid Entry',"Enter age Properly")
                        else:
                            messagebox.showwarning('Invalid Entry',"Enter Mobile Number Properly")
                    else:
                        messagebox.showwarning('Invalid Entry',"Enter no of seats properly")
                else:
                    messagebox.showwarning('Invalid Entry',"Enter name properly")
        #to
    ...
    def Checking_booking():
        ...
        Label(root,text='Check Bus Booking',fg='dark green',font='Arial 15 bold',bg='light green').grid(row=2,column=0,columnspan=12)
    ...
    def Add_new_bus_details_page():
        ...
        #Buttons
        Button(root,text='New Operator',bg='light green',font='Arial 15',command=seat_booking_page1).grid(row=3,column=4)
        Button(root,text='New Bus',font='Arial 15',bg='orange',command=seat_booking_page2).grid(row=3,column=5)
        Button(root,text='New Route',font='Arial 15',bg='light Blue',command=seat_booking_page3).grid(row=3,column=6)
        Button(root,text='New Run',font='Arial 15',bg='red',command=seat_booking_page4).grid(row=3,column=7)
        root.mainloop()
    ...
    def New_Operator():
        ...
        Label(root,text='Add Bus Operator Details',fg='green',font='Arial 20 bold').grid(row=2,column=0,pady=h/40,columnspan=15)
        ...
        def insertintodata(*args):
            ...
            email=email_id.get()
            mob=phone.get()
            cur.execute('''insert into Operator(Operator_ID,Name,Address,email_ID,Phone) values(?,?,?,?,?);''',(oprtr,NaMe,addrs,mob,email))
            con.commit()
        ...
        Button(root,text='Add',font='Arial 15',bg='green',command=checking).grid(row=3,column=12)
        Button(root,text='Edit',font='Arial 15',bg='green',command=checking1).grid(row=3,column=13)
        Button(root,image=homeImage,font='Arial 15',command=checking2).grid(row=4,column=2,columnspan=15,pady=h/50)
    ...
    def New_Bus():
        ...
        Button(root,image=homeImage,font='Arial 15',command=checking2).grid(row=4,column=9)
        root.mainloop()
    ...
    def New_Route():
        ...
        #online bus booking system
        Label(root,text='Online Bus Booking System',fg='Red',bg='LightBlue1',font='Arial 25 bold').grid(row=1,column=0,columnspan=15)
        Label(root,text='Add Bus Route Details',fg='green',font='Arial 22 bold').grid(row=2,column=0,pady=h/40,columnspan=15)
        ...
        def showdetails():
            insertintodata()
            Label(root,text='Route Details',fg='Red',bg='Blue',font='Arial 15').grid(row=6,column=0, columnspan=15,pady=h//30)
        ...
        Button(root,image=homeImage,font='Arial 10',command=checking2).grid(row=5,column=8,pady=h/10)
    ...
    def New_Run():
        ...
        # Buttons for add edit and home
        Button(root,text='Add ',font='Arial 15',bg='pale green',command=check).grid(row=3,column=9)
        Button(root,text='Delete ',font='Arial 15',bg='pale green',fg="Black",command=check1).grid(row=3,column=10)
        Button(root,image=homeImage,font='Arial 15',command=checking2).grid(row=4,column=8,pady=h/20)
        root.mainloop()
